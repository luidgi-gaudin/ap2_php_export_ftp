<div class="neo-container" style="justify-content: center">
    <div class="neo-card">
        <h2>Détails de l'allergie</h2>

        <?php if (isset($allergie)): ?>
            <div class="neo-details">
                <div class="neo-detail-item">
                    <span class="label">Libellé:</span>
                    <span class="value"><?= $allergie->getLibelle() ?></span>
                </div>
            </div>

            <!-- Section des médicaments associés -->
            <div class="neo-section">
                <h3 class="neo-title">Médicaments contenants ce produit</h3>
                        ...
                        <table class="neo-table">
                            ...
                            <?php foreach($medicaments as $medicament): ?>
                                <tr>
                                    ...
                                    <td><?= $medicament->getContrIndication() ?></td>
                                    <td>
                                        <a href="/medicament/details/<?= $medicament->getMedicamentId() ?>" class="neo-btn neo-btn-info neo-btn-small">
                ...
                <?php else: ?>
                    <div class="neo-alert neo-alert-info">
                        Aucun médicament n'est associé à cette allergie.
                    </div>
                <?php endif; ?>
            </div>

            <div class="neo-btn-group" style="margin-top: 2rem;">
                <a href="/allergie" class="neo-btn">Retour</a>
                <a href="/allergie/edit/<?= $allergie->getAllergieId() ?>" class="neo-btn neo-btn-primary">Modifier</a>
                <button class="neo-btn neo-btn-danger" onclick="confirmDelete(<?= $allergie->getAllergieId() ?>)">Supprimer</button>
            </div>
        <?php else: ?>
            <div class="neo-alert neo-alert-danger">
                L'allergie demandée n'existe pas.
            </div>
...
<script>
    function confirmDelete(id) {
        if (confirm("Êtes-vous sûr de vouloir supprimer cette allergie ?")) {
            window.location.href = "/allergie/delete/" + id;
        }
    }
</script>