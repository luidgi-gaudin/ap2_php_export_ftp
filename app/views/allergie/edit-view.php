<div class="container mt-5">
    <div class="row mb-4">
        <div class="col-md-12">
            <div class="d-flex align-items-center">
                <a href="/allergie" class="neo-back-btn me-3">
                    <i class="bi bi-x-lg"></i>
                </a>
                <h1 class="neo-title mb-0">Modifier l'allergie</h1>
            </div>
        </div>
    </div>
    ...
    <div class="neo-card">
        ...
        <form action="/allergie/edit/<?= $data['allergie']->getAllergieId() ?>" method="POST">
            <div class="mb-4">
                <label for="libelle" class="neo-label">Libellé de l'allergie</label>
                <div class="neo-input-container">
                    <input
                        ...
                        id="libelle"
                        name="libelle"
                        value="<?= htmlspecialchars($data['allergie']->getLibelle()) ?>"
                        required
                        autofocus
                    >
                </div>
                <div class="neo-input-help">Entrez un nom clair et descriptif pour cette allergie</div>
            </div>

            <div class="neo-form-actions mt-5">
                <a href="/allergie" class="neo-btn neo-btn-secondary">
